...
namespace HRM.backend.src.HRM.Core.Interfaces.Repositories.TimeAttendance
{
    public interface IAttendanceSummaryRepository : IBaseRepository<AttendanceSummary>
    {
        ...
        Task<List<AttendanceSummary>> GetPendingApprovalAsync(CancellationToken ct = default);
        ...
        Task<List<AttendanceAdjustmentLog>> GetAdjustmentLogsByPeriodAsync(byte month, short year, CancellationToken ct = default);
