...
export const LEGACY_APPROVAL_REDIRECTS: Array<{
  ...
  },
  {
    ...
    to: getApprovalRedirect("ONBOARDING"),
    reason: "Các hồ sơ tiếp nhận nhân sự cần xử lý được gom tại trang Phê duyệt.",
  },
  {
...
export const APPROVAL_WORKFLOW_MAP: ApprovalWorkflowMapItem[] = [
  ...
  },
  {
    ...
    workflowName: "Tiếp nhận hồ sơ nhân sự",
    module: "ONBOARDING",
  ...
  },
  {
    ...
    pendingStatuses: ["PendingDept", "PendingHR"],
  ...
  {
    workflowKey: "ATTENDANCE_TIMESHEET_APPROVAL",
    workflowName: "Duyệt bảng công tháng",
    module: "ATTENDANCE",
    moduleLabel: "Chấm công",
    ownerArea: "Chấm công và nghỉ phép",
    creators: ["HR"],
    approvers: ["Director"],
    pendingStatuses: ["PendingHRReview"],
    approveRoute: getApprovalRedirect("ATTENDANCE"),
    legacyRoutes: ["/attendance-leave/timesheet-summary", "/attendance/summary"],
    scope: "module-adapter",
    status: "active",
    note: "HR tổng hợp và gửi chốt kỳ công; Giám đốc duyệt tại bàn phê duyệt trước khi HR khóa kỳ công.",
  },
  {
    ...
    scope: "module-adapter",
    status: "active",
    note: "Công thức lương chờ Giám đốc duyệt được xử lý tại workspace phê duyệt.",
  },
  {
  ...
  {
    workflowKey: "PENALTY_RECORD_REVIEW",
    workflowName: "Duyệt biên bản vi phạm",
    module: "PERFORMANCE",
    moduleLabel: "Hiệu suất",
    ownerArea: "Hiệu suất và đào tạo",
    creators: ["Manager", "HR"],
    approvers: ["HR", "Director"],
    pendingStatuses: ["PendingHRReview", "PendingDirectorApproval"],
    approveRoute: getApprovalRedirect("PERFORMANCE"),
    legacyRoutes: ["/performance-training/penalties", "/tasks/penalties"],
    scope: "module-adapter",
    status: "active",
    note: "Biên bản vi phạm chờ HR kiểm tra hoặc Giám đốc duyệt được xử lý tại workspace phê duyệt.",
  },
  {
    workflowKey: "TASK_REVIEW",
    workflowName: "Duyệt công việc",
    module: "PERFORMANCE",
    moduleLabel: "Hiệu suất",
    ownerArea: "Hiệu suất và đào tạo",
    creators: ["Employee", "Intern"],
    approvers: ["Manager"],
    pendingStatuses: ["PendingReview"],
    approveRoute: getApprovalRedirect("PERFORMANCE"),
    legacyRoutes: ["/tasks/workspace"],
    scope: "module-adapter",
    status: "active",
    note: "Công việc sau khi nhân sự cập nhật được trưởng phòng duyệt tại workspace phê duyệt.",
  },
  {
    workflowKey: "TRAINING_EVALUATION",
    workflowName: "Đánh giá đào tạo",
    module: "PERFORMANCE",
    moduleLabel: "Hiệu suất",
    ownerArea: "Hiệu suất và đào tạo",
    creators: ["HR", "Manager"],
    approvers: ["Manager", "HR"],
    pendingStatuses: ["PendingEvaluation"],
    approveRoute: getApprovalRedirect("PERFORMANCE"),
    legacyRoutes: ["/tasks/training-evaluation"],
    scope: "module-adapter",
    status: "active",
    note: "Kết quả đào tạo chờ đánh giá được gom vào workspace phê duyệt.",
  },
  {
